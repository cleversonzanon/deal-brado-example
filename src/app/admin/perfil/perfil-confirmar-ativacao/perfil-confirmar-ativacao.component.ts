...
@Component({
  selector: 'app-perfil-confirmar-ativacao',
  templateUrl: './perfil-confirmar-ativacao.component.html',
  styleUrls: ['./perfil-confirmar-ativacao.component.scss']
})
export class PerfilConfirmarAtivacaoComponent extends ModalClose implements OnInit {
  loading = false;
  perfil = {
    perfilName: '',
    perfilId: null,
